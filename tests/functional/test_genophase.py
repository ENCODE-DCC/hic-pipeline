...
@pytest.mark.workflow("test_genophase")
def test_genophase_snp_vcfs_match(workflow_dir, skip_n_lines_md5):
...
@pytest.mark.workflow("test_genophase")
def test_genophase_indel_vcfs_match(workflow_dir, skip_n_lines_md5):
