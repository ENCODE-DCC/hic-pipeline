...
workflow hic {
    meta {
        version: "1.0.0"
        caper_docker: "encodedcc/hic-pipeline:1.0.0"
        caper_singularity: "docker://encodedcc/hic-pipeline:1.0.0"
...
task align {
    ...
    command {
        ...
        ext=""
        singleend=~{if(!defined(fastq_pair.read_2)) then "1" else "0"}
        #count ligations
...
task hiccups {
    ...
    runtime {
        ...
        bootDiskSizeGb: "20"
        disks: "local-disk 100 SSD"
        docker: "encodedcc/hic-pipeline:1.0.0_hiccups"
